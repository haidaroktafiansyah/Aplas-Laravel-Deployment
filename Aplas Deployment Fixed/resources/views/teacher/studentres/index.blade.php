        ...
        <div class="card">
         ...
         <div class="card-body">
           ...
           <div class="form-group">
             ...
             <option value="{{ $item->id }}" {{ $item->id == $filter ? 'selected' : '' }}>{{ $item->name.' ('.$item->email.')' }}</option>
             @endforeach
             </select>
            {{ Form::close() }}
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                        <div class="btn-group">
                                            <a class="btn  btn-info " href="{{ URL::to('/teacher/studentres/'.$filter.'/'.$entity['id']) }}"><i class="fa fa-eye"></i>&nbsp;Show Detail</a>
                                        </div>
                                </td>
                            </tr>
                            @endforeach
